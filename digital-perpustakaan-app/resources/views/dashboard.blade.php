<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            @if (session('error'))
                <div id="toast-danger" class="flex items-center justify-end w-full max-w-xs p-4 mb-4 text-white bg-red-500 rounded-lg shadow " role="alert">
                        ...
                        @foreach ($book as $item)
                            <div
                                ...
                                <div class="p-6 pt-0 flex">
                                    ...
                                    <h2
                                        class="block mb-2 font-sans antialiased font-semibold leading-snug tracking-normal text-gray-900 mt-2 ml-32">
